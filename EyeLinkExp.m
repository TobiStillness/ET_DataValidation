...
%     t = datestr(clock,'YYYY/mm/dd HH:MM:SS:FFF')
%     h = str2num(t([12:13]))
%     m = str2num(t([15:16]))
%     s = str2num(t([18:19]))
%     ms = str2num(t([21:23])) / 1000
%     timestamp = 86400 * (datenum(date) - datenum('01-Jan-1970')) + h*3600 + m*60 + s  + ms;
    % mark zero-plot time in data file
    Eyelink('Message', timestamp);
